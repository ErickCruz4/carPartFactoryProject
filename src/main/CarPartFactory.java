...
public class CarPartFactory {
     ...
     *
     * @param the path to the file containing the info
     ...
     *
     * @param line A line of order information from the file
    ...
    /**
     * Initializes the defectives map with counts set to zero for each car part
     * Uses a hash function and a separate chaining HashTable for efficient storage
     */
    ...
    /**
     * Transfers car parts from the production bin to inventory and tracks defective parts
     * If a part is defective, increments the defect count; otherwise, adds it to the inventory
     */
